...
if(OPENGV_DIR)
  ...
  # Find include dirs
  set(extra_include_paths ${CMAKE_INSTALL_PREFIX}/include "$ENV{OPENGV_DIR}/include" "${PROJECT_SOURCE_DIR}/../opengv" /usr/local/include /usr/include)
  find_path(OPENGV_INCLUDE_DIR opengv/types.hpp
  ...
  # Find libraries
  find_library(OPENGV_LIBS NAMES opengv
    HINTS ${CMAKE_INSTALL_PREFIX}/lib "$ENV{OPENGV_DIR}/lib" "${PROJECT_SOURCE_DIR}/../opengv" /usr/local/lib /usr/lib
    PATH_SUFFIXES ${opengv_build_names}
    DOC "OPENGV libraries")
endif()
